        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 z-10">
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <span className="text-xl font-semibold text-gray-900 dark:text-blue-100 drop-shadow dark:drop-shadow-xl">Scriptura</span>
            </Link>
          </div>
          ...
          <nav className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center space-x-8">
            ...
            <Link
              href="#testimonials"
              className="text-gray-600 dark:text-blue-200 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
            >
              Testimonials
            </Link>
          ...
          <div className="flex items-center space-x-3 z-10">
            ...
            <div className="hidden sm:flex items-center space-x-2">
              <Button variant="ghost" size="sm" className="dark:text-blue-200 dark:hover:bg-[#23263a] dark:hover:text-blue-400">
                Login
              </Button>
            ...
            <Button variant="ghost" size="sm" className="md:hidden dark:text-blue-200 dark:hover:bg-[#23263a] dark:hover:text-blue-400" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          ...
          <div className="md:hidden border-t border-gray-100 dark:border-[#23263a] py-4 bg-white dark:bg-[#181b23]">
            <nav className="flex flex-col space-y-3">
              ...
              <div className="flex flex-col space-y-2 pt-3 border-t border-gray-100 dark:border-[#23263a]">
                <Button variant="ghost" size="sm" className="justify-start dark:text-blue-200 dark:hover:bg-[#23263a] dark:hover:text-blue-400">
                  Login
                </Button>
                <Button size="sm" className="bg-blue-500 hover:bg-blue-600 text-white dark:bg-gradient-to-r dark:from-blue-600 dark:to-blue-400 dark:text-white dark:hover:from-blue-700 dark:hover:to-blue-500 dark:shadow-lg">
                  Sign Up
