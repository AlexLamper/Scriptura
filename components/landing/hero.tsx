            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="flex flex-col space-y-3 pt-6 sm:flex-row sm:space-x-4 sm:space-y-0">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="text-lg font-semibold tracking-wide bg-red-500 hover:bg-[#ef4444e7] dark:border-none text-white dark:bg-red-500 dark:hover:text-white dark:hover:bg-[#ef4444e7]"
                >
