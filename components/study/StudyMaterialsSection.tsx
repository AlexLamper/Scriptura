...
export default function StudyMaterialsSection({
  ...
  return (
    <section 
      ...
      className={`bg-white p-4 sm:p-6 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.1),0_4px_16px_-4px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.15),0_8px_24px_-4px_rgba(0,0,0,0.1)] transition-shadow duration-300 dark:bg-[#181b23] dark:border dark:border-gray-700 ${height ? 'flex flex-col' : ''}`}
    >
