    ...
    <div className="space-y-1 sm:space-y-2 md:space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-1 sm:gap-2 md:gap-4">
        ...
        <div className="space-y-1 sm:space-y-2 md:space-y-4">
          ...
          <select
            className="w-full px-1.5 py-1 text-xs sm:text-sm font-inter border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#798777] focus:border-[#798777] rounded-none dark:bg-card dark:border-border dark:text-foreground dark:focus:ring-[#9aaa98] dark:focus:border-[#9aaa98]"
